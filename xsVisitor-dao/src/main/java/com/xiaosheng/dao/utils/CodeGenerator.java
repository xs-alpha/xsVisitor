package com.xiaosheng.dao.utils;
...
//                .commentDate("yyyy-MM-dd") // 注释日期	默认值: yyyy-MM-dd
        ...
        PackageConfig.Builder packageConfig = new PackageConfig.Builder()
                ...
                .entity("xsVisitor-dao.src.main.java.com.xiaosheng.dao.po") // Entity 包名	默认值:entity
                .service("xsVisitor-services.src.main.java.com.xiaosheng.services.service") // Service 包名	默认值:service
                .mapper("xsVisitor-dao.src.main.java.com.xiaosheng.dao.mapper") // Mapper 包名	默认值:mapper
                .xml("xsVisitor-dao.src.main.resources.mapping") // Mapper XML 包名	默认值:mapper.xml
                ;
